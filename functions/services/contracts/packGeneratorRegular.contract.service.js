...
const {connectToRegularPackGenerator} = require('../web3/networks');
...
class PackGeneratorRegularContractService {

    async getRarities(network = 1) {
        // console.log(network);
        const generator = connectToRegularPackGenerator(network);
...
module.exports = new PackGeneratorRegularContractService();
